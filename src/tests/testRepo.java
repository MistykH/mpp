...
public class testRepo {
    ...
    public void test_all() throws ValidatorException {
        this.test_add();
        this.test_delete();
        this.test_update();
    }

    public void test_add() throws ValidatorException {
    ...
    public void test_update() throws ValidatorException {
        InMemoryRepo<Integer, Book> testRepo= new InMemoryRepo<Integer, Book>();
        ArrayList<Book> bookList = new ArrayList<>();
    ...
    public void test_delete() throws ValidatorException {
        InMemoryRepo<Integer, Book> testRepo= new InMemoryRepo<Integer, Book>();
        ArrayList<Book> bookList = new ArrayList<>();
        Book testBook1 = new Book(1,"authorName","titlu",100,200);
